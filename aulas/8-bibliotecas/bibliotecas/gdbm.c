...
#include <string.h>
#include <gdbm.h>
/* biblioteca para simples bancos de dados
...
// exemplo tirado do GDBM (https://www.gnu.org.ua/software/gdbm/manual/Intro.html)
...
/*
 * compilar com:
 * gcc gdbm.c -o gdbm -lgdbm
 * 
 * criar o banco de dados com:
 * gdbmtool teste.gdbm store foo bar
 */