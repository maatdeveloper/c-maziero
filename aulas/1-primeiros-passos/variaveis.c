...
int somaN(int n) // escopo da funcao
{ 
    return n + 10;
}

int main() {
    auto int juuj = somaN(12);// auto indica que a variavel deve ser iniciada na chamada de uma
    ...
    extern int sla; // extern indica que uma variavel global ja esta definida em outro arquivo e
                    // nao precisa ser alocada novamente
